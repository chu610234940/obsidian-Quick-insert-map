...
async function getTemplateInfo(template) {
    ...
    try {
        ...
        new obsidian__default['default'].Notice("日志含义读取每日笔记模板失败");
        return ["", null];
    }
}
...
class CalendarSettingsTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        if (this.plugin.options.showWeeklyNote &&
            ...
            this.containerEl.createEl("p", {
                cls: "setting-item-description",
                text: "注:周注设置正在移动。建议您安装“定期笔记”插件，以保持未来的功能。.",
            });
    ...
    addWeekStartSetting() {
        ...
        new obsidian.Setting(this.containerEl)
            .setName("周几开始:")
            .setDesc("选择一周中的哪一天开始。选择'默认'使用指定的默认值")
    ...
    addLocaleOverrideSetting() {
        ...
        new obsidian.Setting(this.containerEl)
            .setName("覆盖区域:")
            .setDesc("如果您想使用不同于默认的语言环境，请设置此选项")
            .addDropdown((dropdown) => {
